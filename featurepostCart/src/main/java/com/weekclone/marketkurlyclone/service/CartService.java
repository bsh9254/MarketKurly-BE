...
//        List<Cart> cartCheck = cartRepository.findAllByMemberIdAndProductId(member.getMemberId(), productId);

//        if(cartCheck.size() > 0) {
//            for(Cart carts : cartCheck) {
//                carts.setProductCount(carts.getProductCount() + productCount);
//                carts.setTotalPrice(carts.getTotalPrice() + totalPrice);
//                cartRepository.save(carts);
//            }
//        } else {
//            Cart cart = new Cart(member, productId, productCount, totalPrice);
//            cartRepository.save(cart);
//        }
